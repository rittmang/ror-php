...
var PlayerHandler = function(castPlayer) {
    ...
    this.load = function(mediaIndex) {
        ...
        document.getElementById('media_subtitle').innerHTML =
            castPlayer.mediaContents[castPlayer.currentMediaIndex]['type']+" | "+castPlayer.mediaContents[castPlayer.currentMediaIndex]['year'];
...
CastPlayer.prototype.setupLocalPlayer = function () {
    ...
    playerTarget.load = function(mediaIndex) {
        // console.log("title is"+document.getElementById("moiVideo").src);
        localPlayer.src =
...
CastPlayer.prototype.setupRemotePlayer = function () {
    ...
    playerTarget.load = function (mediaIndex) {
        ...
        var englishSubtitle = new chrome.cast.media.Track(1, // track ID
          ...
          englishSubtitle.trackContentId = this.mediaContents[mediaIndex]['subtitle'];
        ...
        console.log(this.mediaContents[mediaIndex]['sources'][0]);
...
CastPlayer.prototype.initializeUI = function() {
    ...
    document.getElementById('media_subtitle').innerHTML =
        this.mediaContents[this.currentMediaIndex]['type']+" | "+this.mediaContents[this.currentMediaIndex]['year'];
    document.getElementById('media_desc').innerHTML =
...
//             'sources' : ['https://polished-pond-424a.muvibay.workers.dev/Bengali/Jekhane%20Bhooter%20Bhoy/JekhaneBhooterBhoy.mp4'],
//             'subtitle' : 'https://polished-pond-424a.muvibay.workers.dev/Bengali/Jekhane%20Bhooter%20Bhoy/sub.vtt',
//             'thumb' : 'https://polished-pond-424a.muvibay.workers.dev/Bengali/Jekhane%20Bhooter%20Bhoy/wide_poster.jpg',
//             'title' : 'Jekhane Bhuter Bhoy'
//         },
