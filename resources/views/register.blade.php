                  ...
                  <form method="post" action="{{url('register')}}">
                      ...
                      <div class="form-group">
                          ...
                          <input
                                  ...
                                  aria-describedby="nameHelp" required autocomplete="name" autofocus
                          />
                          {{-- @error('email')
                      ...
                      <div class="form-group">
                        ...
                        <input
                                type="text" class="form-control form-control-sm"  id="email" name="email"
