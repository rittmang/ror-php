                                    ...
                                    @if($title->asset!='/')
                                        @if($lastWatched > 0)
                                            @php
                                                ...
                                                $remainingSeconds=$totalSeconds-$lastWatched;

                                                $rem_hours=(int)($remainingSeconds/3600);
                                                $rem_minutes=(int)($remainingSeconds%3600)/60;

                                                $timeLeft="";
                                                if($rem_hours > 0){
                                                    $timeLeft.=(int)$rem_hours."h ";
                                                }
                                                if($rem_minutes>0){
